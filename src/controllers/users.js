    ...
    constructor() {
     ...
     addEmployee(user) {
        return new Promise((resolve,reject) => {
            this.con.query('INSERT INTO `users` (name, email, user_type, DNI, direccion, password) VALUES (?,?,?,?,?,?)', [user.name, user.email, user.user_type, user.DNI, user.direccion, user.password] , function (err, result) {
                if (err) {
